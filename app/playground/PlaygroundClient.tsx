...
export default function PlaygroundClient() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-black">
      ...
      <main className="relative z-10 flex w-full flex-1 flex-col items-center px-6 pb-20 pt-28 sm:pt-32">
        ...
        <section className="mt-16 w-full max-w-5xl border-t border-white/10 pt-8 text-sm text-white/70">
          <h1 className="sr-only">Online image playground for quick cropping and preview</h1>
          <h2 className="text-xl font-semibold text-white sm:text-2xl">
            Try cropping, zooming and panning images in your browser
          </h2>
          <p className="mt-3">
            The Everything Image playground lets you drag, crop and zoom
            around a photo before committing to a download, so you can get a
            feel for how the online editor behaves with your own files.
          </p>
        </section>
      </main>
    </div>
