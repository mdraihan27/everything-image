      ...
      <div className="relative min-h-screen w-full overflow-x-hidden bg-black flex flex-col">
        ...
        <main className="relative z-10 flex w-full flex-1 flex-col items-center px-4 pb-20 pt-28 sm:pt-32">
          ...
          <section className="mt-16 w-full max-w-5xl border-t border-white/10 pt-8 text-sm text-white/70">
            <h1 className="sr-only">Remove image background online and refine the cutout</h1>
            <h2 className="text-xl font-semibold text-white sm:text-2xl">
              Create clean transparent PNGs from product shots and portraits
            </h2>
            <p className="mt-3">
              Use the automatic background remover to cut out your subject, then
              zoom in and erase small edges until your PNG looks ready for
              thumbnails, product listings and social graphics.
            </p>
          </section>
